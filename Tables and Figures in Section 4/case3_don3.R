...
if(Others){
  ...
  out.gtests<-g.tests(E,1:n.u.new,(n.u.new+1):(n.u.new+n.v),test.type="all")
  ...
  save(list=c('test1.energy','test1.crossmatch','out.gtests'),file="case3_don3_others.RData")
...
if(TRUH){
  ...
  save('out',file="case3_don3_truh.RData")
}
